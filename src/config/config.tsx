...
export const header = (category: any) => `News - Top ${category} Headlines`;
export const summary = "Channel and PublishedAt";
export const newsChannel = (channel: any) => `${channel}`;
export const lastUpdate = (published: any) =>
    `${moment(published).format("ddd, DD MM YYYY HH:mm:ss")}`;
...
export const noResultFond = "No Result Found";

export const source = [
    {
        name: "All Data Source",
        key: "all",
    },
    {
        name: "News API",
...
function createMockArticle(id: any) {
    return {
        id: id,
...
export function generateMockArticles(count: any) {
    const articles = [];
